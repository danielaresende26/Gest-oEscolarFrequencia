...
// --- GESTÃO DE USUÁRIOS GLOBAL (Master) ---
router.get('/super/usuarios', superController.listarTodosUsuarios);
router.patch('/super/usuarios/:id', superController.atualizarPerfilUsuario);
